...
const getters: GetterTree<WeatherForecastState, RootState> = {
    ...
    temperatureMax: (state: WeatherForecastState) => Math.max(...getWeatherForecastList(state).map((value: WeatherForecastPart) => value.main.temp_max)),
    temperatureMin: (state: WeatherForecastState) => Math.min(...getWeatherForecastList(state).map((value: WeatherForecastPart) => value.main.temp_min)),
    trendCloud: (state: WeatherForecastState) => getWeatherForecastList(state).map((value: WeatherForecastPart) => value.clouds.all),
    trendHumidity: (state: WeatherForecastState) => getWeatherForecastList(state).map((value: WeatherForecastPart) => value.main.humidity),
    trendPressure: (state: WeatherForecastState) => getWeatherForecastList(state).map((value: WeatherForecastPart) => value.main.pressure),
    trendTemperature: (state: WeatherForecastState) => getWeatherForecastList(state).map((value: WeatherForecastPart) => ({
        temp: value.main.temp,
        temp_min: value.main.temp_min,
        temp_max: value.main.temp_max
    })),
    trendWind: (state: WeatherForecastState) => getWeatherForecastList(state).map((value: WeatherForecastPart) => value.wind),
